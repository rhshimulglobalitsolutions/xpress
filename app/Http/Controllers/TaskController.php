...
class TaskController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return response()->json(['Message' => 'Successfully stored a new Item.']); //returns the stored value if the operation was successful.
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return response()->json(['Message' => 'Successfully Updated.']); // retrieves the updated object from the database
    }
    ...
    public function destroy(string $id)
    {
      ...
      if($task->delete())
        { //deletes the object
            return response()->json(['Message' => 'Successfully deleted.']); //shows a message when the delete operation was successful.
        }
    }
